...
public class BalapkarungKeybindUI : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        foreach (KeyCode key in System.Enum.GetValues(typeof(KeyCode)))
        {
            if (Input.GetKeyDown(key))
            {
                ...
                {
                    KeybindManager.Instance.balapKarungPlayer1 = key;
                    waitingForPlayer1 = false;
                }
                else if (waitingForPlayer2)
                {
                    KeybindManager.Instance.balapKarungPlayer2 = key;
    ...
    public void RefreshUI()
    {
        ...
        SetText(player1Text, KeybindManager.Instance.balapKarungPlayer1.ToString());
        SetText(player2Text, KeybindManager.Instance.balapKarungPlayer2.ToString());
    }
