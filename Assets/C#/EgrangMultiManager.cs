...
public class EgrangMultiManager : MonoBehaviour, IGameplayCheatTarget
{
    [Header("Players")]
    ...
    void Start()
    {
        ...
        StartCoroutine(Player1RhythmLoop());
        StartCoroutine(Player2RhythmLoop());
        UpdateTimerUI();
    }
    ...
    void HandlePlayer1Input()
    {
        ...
        KeyCode expectedKey = player1ExpectingLeft
            ? KeybindManager.Instance.egrangPlayer1Left
            : KeybindManager.Instance.egrangPlayer1Right;
