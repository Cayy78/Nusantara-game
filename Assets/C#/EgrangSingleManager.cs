...
public class EgrangSingleManager : MonoBehaviour, IGameplayCheatTarget
{
    ...
    void OnEnable()
    {
        ...
        UpdatePlayer1Hint();
        UpdatePlayer2Hint();
        gameplayLoopsStarted = false;
        StartGameplayLoopsIfReady();
    }
    ...
    {
        if (KeybindManager.Instance == null || !player1CanInput || player1Finished)
            return;

        KeyCode expectedKey = player1ExpectingLeft
            ? KeybindManager.Instance.egrangSingleLeft
            : KeybindManager.Instance.egrangSingleRight;

        KeyCode wrongKey = player1ExpectingLeft
            ? KeybindManager.Instance.egrangSingleRight
            : KeybindManager.Instance.egrangSingleLeft;
    ...
    {
        if (player1InputHintText == null || KeybindManager.Instance == null)
            return;

        KeyCode currentKey = player1ExpectingLeft
            ? KeybindManager.Instance.egrangSingleLeft
            : KeybindManager.Instance.egrangSingleRight;
    ...
    void UpdatePlayer2Hint()
    {
        ...
        KeyCode currentKey = player2ExpectingLeft
            ? KeybindManager.Instance.egrangPlayer2Left
            : KeybindManager.Instance.egrangPlayer2Right;
    ...
    void StartGameplayLoopsIfReady()
    {
        if (gameplayLoopsStarted || !IsGameplayReady())
            return;

        gameplayLoopsStarted = true;
