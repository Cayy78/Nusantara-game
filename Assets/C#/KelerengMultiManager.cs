...
public class KelerengMultiManager : MonoBehaviour, IGameplayCheatTarget
{
    [Header("Spawn Points")]
    ...
    void ThrowProjectile(int playerIndex, Vector3 spawnPosition, float rawValue)
    {
        ...
        if (projectile != null)
        {
            ...
            projectile.kelerengManager = this;
    ...
    KeyCode GetPlayer1Key()
    {
        return KeybindManager.Instance != null
            ? KeybindManager.Instance.kelerengPlayer1
            : KeyCode.Space;
    }
    ...
    {
        return KeybindManager.Instance != null
            ? KeybindManager.Instance.kelerengPlayer2
            : KeyCode.RightShift;
    }
}
