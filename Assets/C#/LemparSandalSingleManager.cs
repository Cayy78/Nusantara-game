...
public class LemparSandalSingleManager : MonoBehaviour, IGameplayCheatTarget
{
    ...
    void ThrowSandal(int playerIndex, Vector3 spawnPosition, float rawValue)
    {
        ...
        if (projectile != null)
        {
            ...
            projectile.singleManager = this;
            projectile.manager = null;
            projectile.kelerengManager = null;
            projectile.kelerengSingleManager = null;
        }
    ...
    IEnumerator BotLoop()
    {
        while (enabled)
        {
            ...
            ThrowSandal(2, spawnPoint2.position, stoppedValue > 0f ? stoppedValue : rawValue);
        }
    }
    ...
    {
        LemparSandalPowerBar referenceBar = bar2 != null ? bar2 : bar1;
    ...
    KeyCode GetPlayer1Key()
    {
        return KeybindManager.Instance != null
            ? KeybindManager.Instance.lemparSandalSingle
            : KeyCode.Space;
    }
