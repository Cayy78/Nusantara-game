...
public class LompatTaliKeybindUI : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        foreach (KeyCode key in System.Enum.GetValues(typeof(KeyCode)))
        {
            if (Input.GetKeyDown(key))
            {
                ...
                {
                    KeybindManager.Instance.lompatTaliPlayer1 = key;
                    waitingForPlayer1 = false;
                }
                else if (waitingForPlayer2)
                {
                    KeybindManager.Instance.lompatTaliPlayer2 = key;
    ...
    public void RefreshUI()
    {
        ...
        SetText(player1Text, KeybindManager.Instance.lompatTaliPlayer1.ToString());
        SetText(player2Text, KeybindManager.Instance.lompatTaliPlayer2.ToString());
    }
