...
public class PakuBotolKeybindUI : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        foreach (KeyCode key in System.Enum.GetValues(typeof(KeyCode)))
        {
            if (Input.GetKeyDown(key))
            {
                ...
                {
                    KeybindManager.Instance.pakuBotolPlayer1 = key;
                    waitingForPlayer1 = false;
                }
                else if (waitingForPlayer2)
                {
                    KeybindManager.Instance.pakuBotolPlayer2 = key;
    ...
    public void RefreshUI()
    {
        ...
        SetText(player1Text, KeybindManager.Instance.pakuBotolPlayer1.ToString());
        SetText(player2Text, KeybindManager.Instance.pakuBotolPlayer2.ToString());
    }
