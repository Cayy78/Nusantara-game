...
public class PakuBotolMultiManager : MonoBehaviour, IGameplayCheatTarget
{
    ...
    private float player1NextAllowedHitTime;
    private float player2NextAllowedHitTime;
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeybindManager.Instance.pakuBotolPlayer1))
            TryHitPlayer1();

        if (Input.GetKeyDown(KeybindManager.Instance.pakuBotolPlayer2))
            TryHitPlayer2();
    }
