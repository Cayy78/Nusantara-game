...
public class PanjatPinangKeybindUI : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        foreach (KeyCode key in System.Enum.GetValues(typeof(KeyCode)))
        {
            if (Input.GetKeyDown(key))
            {
                ...
                {
                    KeybindManager.Instance.panjatPinangPlayer1 = key;
                    waitingForPlayer1 = false;
                }
                else if (waitingForPlayer2)
                {
                    KeybindManager.Instance.panjatPinangPlayer2 = key;
    ...
    public void RefreshUI()
    {
        ...
        SetText(player1Text, KeybindManager.Instance.panjatPinangPlayer1.ToString());
        SetText(player2Text, KeybindManager.Instance.panjatPinangPlayer2.ToString());
    }
