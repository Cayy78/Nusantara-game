...
public class TarikTambangKeybindUI : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        foreach (KeyCode key in System.Enum.GetValues(typeof(KeyCode)))
        {
            if (Input.GetKeyDown(key))
            {
                ...
                {
                    KeybindManager.Instance.tarikTambangPlayer1 = key;
                    waitingForPlayer1 = false;
                }
                else if (waitingForPlayer2)
                {
                    KeybindManager.Instance.tarikTambangPlayer2 = key;
    ...
    public void RefreshUI()
    {
        ...
        SetText(player1Text, KeybindManager.Instance.tarikTambangPlayer1.ToString());
        SetText(player2Text, KeybindManager.Instance.tarikTambangPlayer2.ToString());
    }
