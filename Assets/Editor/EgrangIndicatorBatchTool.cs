...
public class EgrangIndicatorBatchTool : EditorWindow
{
    ...
    [MenuItem("Tools/Nusantara Battle/Update Egrang Indicator Settings")]
    static void OpenWindow()
    {
        GetWindow<EgrangIndicatorBatchTool>("Egrang Indicators");
    }

    void OnGUI()
    {
        EditorGUILayout.LabelField("Egrang Indicator Batch Tool", EditorStyles.boldLabel);
        ...
        EditorGUILayout.HelpBox(
            "Tool ini hanya mengubah setting panah untuk scene Egrang, baik single player maupun multiplayer.",
            MessageType.Info);

        EditorGUILayout.Space();

        if (GUILayout.Button("Scan Egrang Scenes"))
            ScanScenes();

        if (GUILayout.Button("Apply To Egrang Scenes"))
            ApplyToScenes();
    ...
    void ApplyToScenes()
    {
        ...
        EditorUtility.DisplayDialog(
            "Egrang Indicator Update Complete",
            "Updated " + updatedComponentCount + " loader component(s) across " + changedSceneCount + " Egrang scene(s).",
            "OK");
    }
    ...
    bool ApplySettings(MonoBehaviour loader)
    {
        ...
        bool changed = false;
        Undo.RecordObject(loader, "Update Egrang Indicator Settings");
