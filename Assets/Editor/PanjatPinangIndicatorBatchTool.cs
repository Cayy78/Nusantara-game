...
public class PanjatPinangIndicatorBatchTool : EditorWindow
{
    ...
    [MenuItem("Tools/Nusantara Battle/Update Panjat Pinang Indicator Settings")]
    static void OpenWindow()
    {
        GetWindow<PanjatPinangIndicatorBatchTool>("Panjat Pinang Indicators");
    }

    void OnGUI()
    {
        EditorGUILayout.LabelField("Panjat Pinang Indicator Batch Tool", EditorStyles.boldLabel);
        ...
        EditorGUILayout.HelpBox(
            "Tool ini hanya mengubah setting panah untuk scene Panjat Pinang, baik single player maupun multiplayer.",
            MessageType.Info);

        EditorGUILayout.Space();

        if (GUILayout.Button("Scan Panjat Pinang Scenes"))
            ScanScenes();

        if (GUILayout.Button("Apply To Panjat Pinang Scenes"))
            ApplyToScenes();
    ...
    void ApplyToScenes()
    {
        ...
        EditorUtility.DisplayDialog(
            "Panjat Pinang Indicator Update Complete",
            "Updated " + updatedComponentCount + " loader component(s) across " + changedSceneCount + " Panjat Pinang scene(s).",
            "OK");
    }
    ...
    IEnumerable<string> EnumerateScenePaths()
    {
        ...
        foreach (string sceneGuid in sceneGuids)
        {
            ...
            if (!scenePath.Contains("Panjat Pinang"))
                continue;
    ...
    bool ApplySettings(MonoBehaviour loader)
    {
        ...
        bool changed = false;
        Undo.RecordObject(loader, "Update Panjat Pinang Indicator Settings");
